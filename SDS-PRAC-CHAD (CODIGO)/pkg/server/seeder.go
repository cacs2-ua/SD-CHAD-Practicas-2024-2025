...
func (s *serverImpl) seedPolls() {
	...
	samplePolls := []Poll{
		// programadores
		{
			...
			CreatedBy:  "admin",
			Tags:       []string{"#programacion", "#lenguajes", "#development"},
			SingleVote: false,
		...
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#editor", "#productividad", "#tools"},
			SingleVote: true,
			UserGroup:  "programadores",
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#web", "#framework", "#backend"},
			SingleVote: false,
			UserGroup:  "programadores",
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#scripting", "#automation", "#scripts"},
			SingleVote: true,
			UserGroup:  "programadores",
		},
		{
		...
		// estudiantes
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#calificacion", "#feedback", "#evaluacion"},
			SingleVote: true,
		...
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#estudio", "#aprendizaje", "#metodos"},
			SingleVote: false,
			UserGroup:  "estudiantes",
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#productividad", "#horas", "#rutina"},
			SingleVote: true,
			UserGroup:  "estudiantes",
		},
		...
		// deportistas
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#deporte", "#actividad", "#fitness"},
			SingleVote: false,
		...
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#futbol", "#equipos", "#fans"},
			SingleVote: true,
			UserGroup:  "deportistas",
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#recuperacion", "#hidratacion", "#salud"},
			SingleVote: true,
			UserGroup:  "deportistas",
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#warmup", "#calentamiento", "#fitness"},
			SingleVote: false,
			UserGroup:  "deportistas",
		},
		...
		// oradores
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#debate", "#oratoria", "#temas"},
			SingleVote: true,
			UserGroup:  "oradores",
		},
		{
		...
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#retorica", "#literatura", "#oratoria"},
			SingleVote: true,
			UserGroup:  "oradores",
		},
		...
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#color", "#diseño", "#estetica"},
			SingleVote: true,
			UserGroup:  "",
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#comida", "#takeaway", "#food"},
			SingleVote: false,
			UserGroup:  "",
		},
		{
			...
			EndDate:    time.Now().Add(24 * time.Hour),
			CreatedBy:  "admin",
			Tags:       []string{"#estaciones", "#clima", "#preferencias"},
			SingleVote: true,
			UserGroup:  "",
		},
		{
